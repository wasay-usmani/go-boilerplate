...
func TestAddSet(t *testing.T) {
	...
	mockClient.EXPECT().Do(ctx, mock.Match("SADD", fmt.Sprintf("%s::%s", "test_keyspace", set), value)).
		Return(mock.Result(mock.ValkeyInt64(1)))
...
func TestContainsSet(t *testing.T) {
	...
	mockClient.EXPECT().Do(ctx, mock.Match("SISMEMBER", fmt.Sprintf("%s::%s", "test_keyspace", set), value)).
		Return(mock.Result(mock.ValkeyInt64(1)))
...
func TestRemoveSetValues(t *testing.T) {
	...
	mockClient.EXPECT().Do(ctx, mock.Match("SREM", fmt.Sprintf("%s::%s", "test_keyspace", set), values[0], values[1])).
		Return(mock.Result(mock.ValkeyInt64(2)))
